...
<%@ page import="java.sql.PreparedStatement, java.sql.ResultSet, java.sql.Connection, java.sql.DriverManager,
 ...
 ResultSet rs=st.executeQuery("SELECT * FROM PIZZA_TBL");
 while(rs.next()) {
...
<input id="search2" name="q" type="text" placeholder="Search by ID / NAME" required>
<input id="search1" type="submit" value="Search">
<button id="reset" type="reset" value="Reset">Reset</button>
</form>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<form action="FilterPizza.jsp">
<input id="filter2" name="q" type="text" placeholder="Filter By Veg / Non-Veg" required>
<input id="filter1" type="submit" value="Filter">
<button id="reset" type="reset" value="Reset">Reset</button>
</form>
...
<th><font size="3px" color="#383745">EDIT</font></th><th><font size="3px" color="#383745">DELETE</font></th></tr>
<%
for(Pizza each:all) {
%>
<tr>
